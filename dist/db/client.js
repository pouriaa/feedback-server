...
export function getPrisma() {
    if (!globalForPrisma.prisma) {
        throw new Error("[DB] Prisma client not initialized. Call initializePrisma() first.");
    }
    ...
    get(_target, prop) {
        if (!globalForPrisma.prisma) {
            ...
            if (!isWorkersEnvironment) {
                ...
                throw new Error("[DB] In Workers environment, call initializePrisma() before accessing prisma");
            }
        }
