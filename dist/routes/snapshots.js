 ...
 */
router.post("/", snapshotRateLimiter, validateBody(SnapshotDataSchema), (req, res) => snapshotController.create(req, res));
/**
 * GET /snapshots/:id
 * Get snapshot by ID (utility endpoint)
 */
router.get("/:id", (req, res) => snapshotController.getById(req, res));
